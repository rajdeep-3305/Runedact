    ...
    <Modal
      ...
      actions={
        <button
          ...
          disabled={isRunning}
          className="flex items-center gap-1.5 rounded-md bg-amber-400 px-2.5 py-1 text-[11px] font-semibold text-zinc-950 transition hover:bg-amber-300 disabled:cursor-not-allowed disabled:opacity-40 cursor-pointer"
        >
          {isRunning && (
      ...
      <div className="space-y-5 p-4 text-xs">
        {!report ? (
          <div className="py-8 text-center">
            <p className="font-mono text-[11px] text-zinc-500">no results yet</p>
          ...
          <>
            ...
            <div className="grid grid-cols-4 gap-2">
              <div className="col-span-1 rounded-md border border-zinc-800 bg-zinc-900/40 p-3">
                ...
                <div className="font-mono text-[9px] text-zinc-600">target 0.0%</div>
              </div>
              <div className="rounded-md border border-zinc-800 bg-zinc-900/40 p-3">
                ...
                <div className="font-mono text-[9px] text-zinc-600">/100</div>
              </div>
              <div className="rounded-md border border-zinc-800 bg-zinc-900/40 p-3">
                <div className="font-mono text-[9px] uppercase tracking-widest text-zinc-600">
                  relevance
              ...
              <div className="rounded-md border border-zinc-800 bg-zinc-900/40 p-3">
                ...
                <div className="font-mono text-[9px] text-zinc-600">ms avg</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="overflow-hidden rounded-md border border-zinc-800">
                <table className="w-full text-left font-mono text-[11px]">
                  <thead className="border-b border-zinc-800 bg-zinc-900/60 text-[9px] uppercase tracking-widest text-zinc-500">
                    <tr>
              ...
              <div>
                ...
                <div className="space-y-1">
                  {history.slice(0, 5).map((h) => (
                    <div
                      key={h.id}
                      className="flex items-center justify-between rounded border border-zinc-800/70 bg-zinc-900/30 px-3 py-1.5 font-mono text-[10px]"
                    >
