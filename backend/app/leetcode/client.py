"""Read-only client for LeetCode's unofficial GraphQL API.

Fetches problem statements for browsing. Imported problems never feed the
sandbox — there are no hidden test cases to grade them with, so this stays a
catalog viewer. Responses are cached in-process to keep request volume low.
"""
...
class LeetCodeClient:
    ...
    def question(self, slug: str) -> Dict[str, Any]:
        ...
        detail = {
            ...
            "description": html_to_text(q["content"]) if q.get("content") else "",
